...
export const AnswerDetails = (props) => {
  return (
    <div className='col-md-6'>
      <div className="answer-details card">
      <div className='card-body'>
        ...
        <ul className="list-group list-group-flush">
          ...
          <li className="list-group-item">Latin</li>
            <li className="list-group-item">
              <AudioPlayer src="https://www.xeno-canto.org/sounds/uploaded/VOLIQOYWKG/XC489247-190724_09.10h_huiszwaluw_biesbosch_amaliahoeve_roep_100%2Bex_fouragerend_gezien_%20%282%29.mp3" />
            </li>
      </ul>
      </div>
